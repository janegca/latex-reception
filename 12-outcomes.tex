...
If the first joining of the querent's significator and is to a malefic and does not involve reception and if the malefic is not the significator of the quesited;  a \textsl{prohibition} is indicated [JH p35].
\end{frame}