...
\vspace{0.25cm}
While Sahl denies reception if a planet is in his own Fall or applying to another planet from its Fall, the other authors appear to accept the reception but say that it is corrupted or greatly diminished i.e. the outcome to the matter is far less than what was hoped for or fails to last.\\
\vspace{0.25cm}
