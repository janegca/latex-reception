...
\footnotetext[1]{The examples used by Masha'Allah so far involve signs of a planets Fall or Detriment which we will see (in later examples), may result in a commitment being rejected.}
\end{frame}
