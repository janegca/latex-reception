...
\end{frame}
% -------------------------------------------------------------------
\subsubsection{Perfect Reception: Pushing Nature}
\begin{frame}[t]{What Constitutes Reception - Perfect Reception: Pushing Nature}
\vspace{0.1cm}
\begin{columns}[T, onlytextwidth]
\column{0.5\textwidth}
An example of \textbf{perfect reception} (according to Sahl) is a planet applying to the domicile or exaltation ruler of the sign it occupies. Abu Ma'shar calls it \textsl{"pushing nature"}, Ibn Ezra, \textsl{"conferring of nature"}.\footnotemark[1] As signs have the same nature as their rulers, \textsl{A}, being in \textsl{B's} sign, pushes \textsl{B}'s own nature onto B.\\
\vspace{0.2cm}
...
\end{columns}
\vspace{0.2cm}
\footnotetext[1]{Sahl, p.18, Abu Ma'shar p.24, Ibn Ezra p.121}
\end{frame}
% ----------------------------------------------------
