...
\begin{columns}[T, onlytextwidth]
\column{0.5\textwidth}
When a planet (A) in its domicile or exaltation applies to another planet (B) who also has dignity in \textsl{A's} place\footnotemark[1] \textsl{A} is said to be pushing two natures onto \textsl{B}; his own and \textsl{B}'s.\\
\vspace{0.25cm}
